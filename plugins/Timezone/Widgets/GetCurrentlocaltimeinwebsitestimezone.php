 ...
 *
 */
namespace Piwik\Plugins\Timezone\Widgets;
...
class GetCurrentlocaltimeinwebsitestimezone extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         */
        $config->setName('Timezone_Currentlocaltimeinwebsitestimezone');
    ...
    public function render()
    {
        ...
        $labelLocalTimezone = Piwik::translate('Timezone_LocalTimezone');
        $labelSiteTimezone = Piwik::translate('Timezone_SiteTimezone');

        $valueSiteTimezone = date('Y/m/d H:i');

        return "<div vue-entry='Timezone.TimezoneComponent' label-local-timezone='$labelLocalTimezone' label-site-timezone='$labelSiteTimezone' value-site-timezone-from-backend='$valueSiteTimezone'></div>";
    }
